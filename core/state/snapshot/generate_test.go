...
func testGeneration(t *testing.T, scheme string) {
	...
	helper.addTrieAccount("acc-1", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
	helper.addTrieAccount("acc-2", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(2), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()})
	helper.addTrieAccount("acc-3", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(3), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
	...
	if have, want := root, common.HexToHash("0x6aa74b791e2c803dc2a004cd6dc4942dd35bf88c56fc4eead5168fac7dc8d738"); have != want {
...
func testGenerateExistentState(t *testing.T, scheme string) {
	...
	helper.addTrieAccount("acc-1", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
	helper.addSnapAccount("acc-1", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
	helper.addSnapStorage("acc-1", []string{"key-1", "key-2", "key-3"}, []string{"val-1", "val-2", "val-3"})

	helper.addTrieAccount("acc-2", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(2), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()})
	helper.addSnapAccount("acc-2", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(2), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()})

	stRoot = helper.makeStorageTrie("acc-3", []string{"key-1", "key-2", "key-3"}, []string{"val-1", "val-2", "val-3"}, true)
	helper.addTrieAccount("acc-3", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(3), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
	helper.addSnapAccount("acc-3", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(3), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
...
func testGenerateExistentStateWithWrongStorage(t *testing.T, scheme string) {
	...
	helper.addAccount("acc-1", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()})
	helper.addSnapStorage("acc-1", []string{"key-1", "key-2", "key-3"}, []string{"val-1", "val-2", "val-3"})

	// Account two, non empty root but empty database
	stRoot := helper.makeStorageTrie("acc-2", []string{"key-1", "key-2", "key-3"}, []string{"val-1", "val-2", "val-3"}, true)
	helper.addAccount("acc-2", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})

	// Miss slots
	{
		// Account three, non empty root but misses slots in the beginning
		helper.makeStorageTrie("acc-3", []string{"key-1", "key-2", "key-3"}, []string{"val-1", "val-2", "val-3"}, true)
		helper.addAccount("acc-3", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
		helper.addSnapStorage("acc-3", []string{"key-2", "key-3"}, []string{"val-2", "val-3"})

		// Account four, non empty root but misses slots in the middle
		helper.makeStorageTrie("acc-4", []string{"key-1", "key-2", "key-3"}, []string{"val-1", "val-2", "val-3"}, true)
		helper.addAccount("acc-4", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
		helper.addSnapStorage("acc-4", []string{"key-1", "key-3"}, []string{"val-1", "val-3"})

		// Account five, non empty root but misses slots in the end
		helper.makeStorageTrie("acc-5", []string{"key-1", "key-2", "key-3"}, []string{"val-1", "val-2", "val-3"}, true)
		helper.addAccount("acc-5", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
	...
	// Wrong storage slots
	{
		...
		helper.addAccount("acc-6", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
		helper.addSnapStorage("acc-6", []string{"key-1", "key-2", "key-3"}, []string{"badval-1", "val-2", "val-3"})

		// Account seven, non empty root but wrong slots in the middle
		helper.makeStorageTrie("acc-7", []string{"key-1", "key-2", "key-3"}, []string{"val-1", "val-2", "val-3"}, true)
		helper.addAccount("acc-7", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
		helper.addSnapStorage("acc-7", []string{"key-1", "key-2", "key-3"}, []string{"val-1", "badval-2", "val-3"})

		// Account eight, non empty root but wrong slots in the end
		helper.makeStorageTrie("acc-8", []string{"key-1", "key-2", "key-3"}, []string{"val-1", "val-2", "val-3"}, true)
		helper.addAccount("acc-8", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
		helper.addSnapStorage("acc-8", []string{"key-1", "key-2", "key-3"}, []string{"val-1", "val-2", "badval-3"})

		// Account 9, non empty root but rotated slots
		helper.makeStorageTrie("acc-9", []string{"key-1", "key-2", "key-3"}, []string{"val-1", "val-2", "val-3"}, true)
		helper.addAccount("acc-9", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
	...
	// Extra storage slots
	{
		...
		helper.addAccount("acc-10", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
		helper.addSnapStorage("acc-10", []string{"key-0", "key-1", "key-2", "key-3"}, []string{"val-0", "val-1", "val-2", "val-3"})

		// Account 11, non empty root but extra slots in the middle
		helper.makeStorageTrie("acc-11", []string{"key-1", "key-2", "key-3"}, []string{"val-1", "val-2", "val-3"}, true)
		helper.addAccount("acc-11", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
		helper.addSnapStorage("acc-11", []string{"key-1", "key-2", "key-2-1", "key-3"}, []string{"val-1", "val-2", "val-2-1", "val-3"})

		// Account 12, non empty root but extra slots in the end
		helper.makeStorageTrie("acc-12", []string{"key-1", "key-2", "key-3"}, []string{"val-1", "val-2", "val-3"}, true)
		helper.addAccount("acc-12", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
...
func testGenerateExistentStateWithWrongAccounts(t *testing.T, scheme string) {
	...
	{
		helper.addTrieAccount("acc-1", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()}) // Beginning
		helper.addTrieAccount("acc-4", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()}) // Middle
		helper.addTrieAccount("acc-6", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()}) // End
	}

	// Wrong accounts
	{
		helper.addTrieAccount("acc-2", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
		helper.addSnapAccount("acc-2", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: common.Hex2Bytes("0x1234")})

		helper.addTrieAccount("acc-3", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
		helper.addSnapAccount("acc-3", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()})
	}

	// Extra accounts, only in the snap
	{
		helper.addSnapAccount("acc-0", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})              // before the beginning
		helper.addSnapAccount("acc-5", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: types.EmptyRootHash, CodeHash: common.Hex2Bytes("0x1234")})  // Middle
		helper.addSnapAccount("acc-7", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()}) // after the end
	}
...
func testGenerateCorruptAccountTrie(t *testing.T, scheme string) {
	...
	helper.addTrieAccount("acc-1", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()}) // 0xc7a30f39aff471c95d8a837497ad0e49b65be475cc0953540f80cfcdbdcd9074
	helper.addTrieAccount("acc-2", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(2), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()}) // 0x65145f923027566669a1ae5ccac66f945b55ff6eaeb17d2ea8e048b7d381f2d7
	helper.addTrieAccount("acc-3", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(3), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()}) // 0x19ead688e907b0fab07176120dceec244a72aff2f0aa51e8b827584e378772f4

	root := helper.Commit()

	// Delete an account trie node and ensure the generator chokes.
	// Look up the node hash dynamically since it depends on the account RLP encoding.
	targetPath := []byte{0xc}
	accTrie, _ := trie.NewStateTrie(trie.StateTrieID(root), helper.triedb)
	nodeIt, _ := accTrie.NodeIterator(nil)
	var targetHash common.Hash
	for nodeIt.Next(true) {
		if len(nodeIt.Path()) == len(targetPath) && nodeIt.Path()[0] == targetPath[0] {
			targetHash = nodeIt.Hash()
			break
		}
	}
...
func testGenerateMissingStorageTrie(t *testing.T, scheme string) {
	...
	helper.addTrieAccount("acc-1", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})              // 0x9250573b9c18c664139f3b6a7a8081b7d8f8916a8fcc5d94feec6c29f5fd4e9e
	helper.addTrieAccount("acc-2", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(2), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()}) // 0x65145f923027566669a1ae5ccac66f945b55ff6eaeb17d2ea8e048b7d381f2d7
	stRoot = helper.makeStorageTrie("acc-3", []string{"key-1", "key-2", "key-3"}, []string{"val-1", "val-2", "val-3"}, true)
	helper.addTrieAccount("acc-3", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(3), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()}) // 0x50815097425d000edfc8b3a4a13e175fc2bdcfee8bdfbf2d1ff61041d3c235b2
...
func testGenerateWithExtraAccounts(t *testing.T, scheme string) {
	helper := newHelper(scheme)
	{
		...
		acc := &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()}
		val, _ := rlp.EncodeToBytes(acc)
...
func testGenerateWithManyExtraAccounts(t *testing.T, scheme string) {
	...
	}
	{
		...
		for i := 0; i < 1000; i++ {
			acc := &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(uint64(i)), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()}
			val, _ := rlp.EncodeToBytes(acc)
...
func testGenerateWithExtraBeforeAndAfter(t *testing.T, scheme string) {
	...
	helper := newHelper(scheme)
	{
		acc := &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()}
		val, _ := rlp.EncodeToBytes(acc)
...
func testGenerateFromEmptySnap(t *testing.T, scheme string) {
	...
	for i := 0; i < 400; i++ {
		...
		helper.addTrieAccount(fmt.Sprintf("acc-%d", i),
			&types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
	}
	root, snap := helper.CommitAndGenerate()
...
func testGenerateWithIncompleteStorage(t *testing.T, scheme string) {
	...
	for i := 0; i < 8; i++ {
		...
		helper.addAccount(accKey, &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(uint64(i)), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
...
func testGenerateCompleteSnapshotWithDanglingStorage(t *testing.T, scheme string) {
	...
	stRoot := helper.makeStorageTrie("acc-1", []string{"key-1", "key-2", "key-3"}, []string{"val-1", "val-2", "val-3"}, true)
	helper.addAccount("acc-1", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: stRoot, CodeHash: types.EmptyCodeHash.Bytes()})
	helper.addAccount("acc-2", &types.StateAccount{Flags: types.YieldDisabled, Fixed: uint256.NewInt(1), Shares: new(uint256.Int), Debt: new(uint256.Int), Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash.Bytes()})
